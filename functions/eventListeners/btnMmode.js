...
document.querySelector('.btn-medium-mode').addEventListener('click',()=>{
    mediumMode = true;
    document.querySelector('.span-level').innerText = 'Medium'
    endGame = 600;
...
setInterval(()=>{
    ...
    setInterval(()=>{
        ...
        setInterval(()=>{
            ...
            setInterval(()=>{
                if(!boxLimitReturnForLevel2(oddPackages2ndLevelBot1, 15)){
                ...
                setInterval(()=>{
                    if(!boxLimitReturnForLevel2(evenPackages2ndLevelBot2, 15)){
